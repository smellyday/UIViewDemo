...
- (BOOL) isBeforeDateIgnoringTime: (NSDate *) aDate
{
    NSDateComponents *components1 = [[NSDate currentCalendar] components:componentFlags fromDate:self];
    NSDateComponents *components2 = [[NSDate currentCalendar] components:componentFlags fromDate:aDate];
    
    if (components1.year > components2.year) return NO;
    if (components1.year < components2.year) return YES;
    
    if (components1.month > components2.month) return NO;
    if (components1.month < components2.month) return YES;
...
- (BOOL) isAfterDateIgnoringTime: (NSDate *) aDate
{
    NSDateComponents *components1 = [[NSDate currentCalendar] components:componentFlags fromDate:self];
    NSDateComponents *components2 = [[NSDate currentCalendar] components:componentFlags fromDate:aDate];
