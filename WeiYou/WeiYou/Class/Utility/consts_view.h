...
#define NAV_BAR_BTN_H             44
#define NAV_BAR_LEFT_BTN_FRAME    CGRectMake(0, STATUS_BAR_H, NAV_BAR_BTN_W, NAV_BAR_H)
#define NAV_BAR_RIGHT_BTN_FRAME   CGRectMake(SCREEN_WIDTH-NAV_BAR_BTN_W, STATUS_BAR_H, NAV_BAR_BTN_W, NAV_BAR_H)
#define NAV_BAR_CONTAINER_FRAME   CGRectMake(0, 0, SCREEN_WIDTH, NAV_BAR_H+STATUS_BAR_H)
#define NAV_BAR_TITLE_W           100*APP_SCALE_W
#define NAV_BAR_TITLE_FRAME       CGRectMake(SCREEN_WIDTH/2-NAV_BAR_TITLE_W/2, STATUS_BAR_H, NAV_BAR_TITLE_W, NAV_BAR_H)
