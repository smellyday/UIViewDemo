...
-(void)layoutBottomView{
    if(!self.bottomRightView){
        ...
        _bottomRightView.backgroundColor = [UIColor redColor];
...
//        self.contentView.layer.position = CGPointMake(newCenterPosition, self.contentView.center.y);
        self.contentView.center = CGPointMake(newCenterPosition, self.contentView.center.y);
