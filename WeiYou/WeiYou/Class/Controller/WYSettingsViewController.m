...
- (void)viewDidLoad
{
    ...
    // login notification.
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(doWhenSinaLoginSuccess:) name:NOTI_LOGIN_OK object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(doWhenQQLoginSuccess:) name:NOTI_LOGIN_OK object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(doWhenWYLoginSuccess:) name:NOTI_LOGIN_OK object:nil];
